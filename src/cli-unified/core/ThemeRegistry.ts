...
export const MinimalTheme = {
  ...
  colors: {
    ...
    border: chalk.gray, llamacpp: chalk.magenta, gemini: chalk.cyan,
  ...
  symbols: {
    ...
    llamacpp: 'LLAMACPP', gemini: 'GEMINI', star: '*', heart: '<3',
...
export const NeonTheme = {
  ...
  colors: {
    ...
    llamacpp: chalk.hex('#bf5fff'), gemini: chalk.hex('#00e5ff'),
...
export const MonokaiTheme = {
  ...
  colors: {
    ...
    llamacpp: chalk.hex('#ae81ff'), gemini: chalk.hex('#66d9ef'),
...
export const DraculaTheme = {
  ...
  colors: {
    ...
    llamacpp: chalk.hex('#bd93f9'), gemini: chalk.hex('#8be9fd'),
...
export const WitcherTheme = {
  ...
  colors: {
    ...
    llamacpp: chalk.hex('#8b4513'), gemini: chalk.hex('#4169e1'),
...
export const CyberpunkTheme = {
  ...
  colors: {
    ...
    llamacpp: chalk.hex('#9d00ff'), gemini: chalk.hex('#00fff9'),
